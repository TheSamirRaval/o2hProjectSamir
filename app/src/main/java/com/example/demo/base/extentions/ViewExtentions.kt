...
fun View.updateMargin(left: Int, top: Int, right: Int, bottom: Int) {
    when {
        this.layoutParams is androidx.coordinatorlayout.widget.CoordinatorLayout.LayoutParams -> {
            val layoutParams =
                this.layoutParams as androidx.coordinatorlayout.widget.CoordinatorLayout.LayoutParams
